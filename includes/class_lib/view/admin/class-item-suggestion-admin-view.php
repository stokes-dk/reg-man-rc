...
//							'<input type="checkbox" autocomplete="off" name="create[%1$s]" class="create_suggestion" value="1" checked="checked">' .
	...
	public static function update_post_messages( $messages ) {
		...
		$messages[ Item_Suggestion::POST_TYPE ] = array(
				0 => '',
				1 => sprintf( __('Item Suggestion updated. <a href="%s">View</a>'), esc_url( $permalink ) ),
				2 => __('Custom field updated.'),
				3 => __('Custom field deleted.'),
				4 => __('Item updated.'),
				5 => isset($_GET['revision']) ? sprintf( __('Item Suggestion restored to revision from %s'), wp_post_revision_title( (int) $_GET['revision'], FALSE ) ) : FALSE,
				6 => sprintf( __('Item Suggestion published. <a href="%s">View</a>'), esc_url( $permalink ) ),
				7 => __('Item saved.'),
				8 => sprintf( __('Item Suggestion submitted. <a target="_blank" href="%s">Preview</a>'), esc_url( add_query_arg( 'preview', 'true', $permalink ) ) ),
				9 => sprintf( __('Item Suggestion scheduled for: <strong>%1$s</strong>. <a target="_blank" href="%2$s">Preview</a>'), $date, esc_url( $permalink ) ),
				10 => sprintf( __('Item Suggestion draft updated. <a target="_blank" href="%s">Preview</a>'), esc_url( add_query_arg( 'preview', 'true', $permalink ) ) ),
		);
		return $messages;
	} // function
